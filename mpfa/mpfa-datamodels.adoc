...
:copyright-year: 2019
:language: en
:title-intro-en: MFPA datamodels
:title-main-en: document and funds reference models
:doctype: industry-standard
:language: en
:script: Latn
:draft:
:toc:
...
This document provides the MPFA reference models for offering documents and brochures. Implementation of the reference model and serialisation formats are out of scope of this document.
...
// Surely the following preface can be suppressed
...
* A _Preface_, consisting of a mandatory _Foreword_ (a Basic Section: <<basicsection>>), and an optional _Introduction_ (a HierarchicalSection: <<standardssection>>, since an ISO Introduction can optionally have numbered subsections).
